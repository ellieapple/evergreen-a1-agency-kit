...
async function optimizeContent(url, keyword, business) {
...
async function generateSocialContent(business, platforms, topic, period, postsPerPlatform) {
...
async function findBacklinks(url, business) {
